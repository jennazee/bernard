...
"use strict";function _interopRequireWildcard(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&(t[r]=e[r]);return t.default=e,t}function processVoterData(){return csv.csv().fromString(_voters.voters).then(function(e){return e})}function queryMatchesVoterField(e){var t=e.normalizedQuery;return-1!==normalizeString(e.voter[e.field]).indexOf(t)}function searchByName(e){var t=e.query,r=e.voters;if(t.length<3)return[];for(var n=(Object.keys(r[0]),r.length),o=[],s=normalizeString(t),a=0;a<n;a++){var i=r[a];(queryMatchesVoterField({normalizedQuery:s,voter:i,field:FIRST_NAME})||queryMatchesVoterField({normalizedQuery:s,voter:i,field:LAST_NAME}))&&o.push(i)}return o}function searchByAddress(e){var t=e.query,r=e.voters;if(t.length<3)return[];for(var n=(Object.keys(r[0]),r.length),o=[],s=normalizeString(t),a=0;a<n;a++){var i=r[a];(queryMatchesVoterField({normalizedQuery:s,voter:i,field:ADDRESS})||queryMatchesVoterField({normalizedQuery:s,voter:i,field:CITY})||queryMatchesVoterField({normalizedQuery:s,voter:i,field:ZIP}))&&o.push(i)}return o}function renderResults(e){return console.log(e),e.length?'\n    <thead class="Results-header">\n        <tr><th class="Results-header_cell"></th>'+Object.keys(e[0]).filter(function(e){return"isSelected"!==e}).map(function(e){return'<th class="Results-header_cell">'+e+"</th>"}).join("")+"</tr>\n    </thead>\n    <tbody>\n        "+e.map(function(e){return'<tr class="Results-row"><td class="Results-row_cell"><input type="checkbox" data-id="'+e[VOTERID]+'" '+(e.isSelected?"checked":"")+"></td>"+Object.keys(e).filter(function(e){return"isSelected"!==e}).map(function(t){return'<td class="Results-row_cell">'+e[t]+"</td>"}).join("")+"</tr>"}).join("")+"\n    </tbody>\n    ":""}function normalizeString(e){return(0,_lodash.deburr)(e.toLocaleLowerCase())}function exportResults(e){exportCSVFile(e.filter(function(e){return e.isSelected}).map(function(e){return delete e.isSelected,e}))}function convertToCSV(e){for(var t="object"!==(void 0===e?"undefined":_typeof(e))?JSON.parse(e):e,r="",n=0;n<t.length;n++){var o="";for(var s in t[n])""!=o&&(o+=","),o+=t[n][s];r+=o+"\r\n"}return r}function exportCSVFile(e){var t=JSON.stringify(e),r=convertToCSV(t),n=new Blob([r],{type:"text/csv;charset=utf-8;"});if(navigator.msSaveBlob)navigator.msSaveBlob(n,"voters.csv");else{var o=document.createElement("a");if(void 0!==o.download){var s=URL.createObjectURL(n);o.setAttribute("href",s),o.setAttribute("download","voters.csv"),o.style.visibility="hidden",document.body.appendChild(o),o.click(),document.body.removeChild(o)}}}function init(){processVoterData().then(function(e){var t="",r="";document.querySelector(".Wrapper--loading").classList.remove("Wrapper--loading"),document.querySelector('[data-js="input-name"]').addEventListener("keyup",function(r){t=r.target.value,document.querySelector('[data-js="name-results"]').innerHTML=renderResults(searchByName({query:t,voters:e}))}),document.querySelector('[data-js="input-address"]').addEventListener("keyup",function(t){r=t.target.value,document.querySelector('[data-js="address-results"]').innerHTML=renderResults(searchByAddress({query:r,voters:e}))}),document.querySelector('[data-js="name-results"]').addEventListener("change",function(t){if(t.target.matches("input")){var n=t.target.dataset.id,o=e.find(function(e){return e[VOTERID]===n});t.target.checked?o.isSelected=!0:o.isSelected=!1,document.querySelector('[data-js="address-results"]').innerHTML=renderResults(searchByAddress({query:r,voters:e}))}}),document.querySelector('[data-js="address-results"]').addEventListener("change",function(r){if(r.target.matches("input")){var n=r.target.dataset.id,o=e.find(function(e){return e[VOTERID]===n});r.target.checked?o.isSelected=!0:o.isSelected=!1,document.querySelector('[data-js="name-results"]').innerHTML=renderResults(searchByName({query:t,voters:e}))}}),document.querySelector('[data-js="export-button"]').addEventListener("click",function(t){exportResults(e)})})}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},_csvtojson=require("csvtojson"),csv=_interopRequireWildcard(_csvtojson),_voters=require("./voters.js"),_lodash=require("lodash"),FIRST_NAME="First",LAST_NAME="Last",ADDRESS="Address",CITY="City",ZIP="Zip",VOTERID="Voter id";init();

},{"./voters.js":4,"csvtojson":2,"lodash":3}],2:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var voters=exports.voters="First, Last, Age, Gender, Party, Address, City, Zip, Voter id\nAmelia, Bedelia, 30, F, Dem, 94 Main, Brooklyn, 11215, 1\nLauren, Smith, 64, F, Dem, 18 Elm, Richmond, 12345, 2\nScott, Smith, 65, M, Dem, 18 Elm, Richmond, 12345, 3\nJosh, Smith, 25, M, Dem, 18 Elm, Richmond, 12345, 4";
