...
"use strict";function _interopRequireWildcard(e){if(e&&e.__esModule)return e;var r={};if(null!=e)for(var t in e)Object.prototype.hasOwnProperty.call(e,t)&&(r[t]=e[t]);return r.default=e,r}function processVoterData(){return csv.csv().fromString(_voters.voters).then(function(e){return e})}function search(e){var r=e.query,t=e.voters;if(r.length<3)return[];for(var n=Object.keys(t[0]),o=t.length,s=n.length,u=[],a=normalizeString(r),i=0;i<o;i++)for(var c=t[i],l=0;l<s;l++){var d=n[l];if(-1!==normalizeString(c[d]).indexOf(a)){u.push(c);break}}return u}function renderResults(e){return e.length?'\n    <thead class="Results-header">\n        <tr>'+Object.keys(e[0]).map(function(e){return'<th class="Results-header_cell">'+e+"</th>"}).join("")+"</tr>\n    </thead>\n    <tbody>\n        "+e.map(function(e){return'<tr class="Results-row">'+Object.values(e).map(function(e){return'<td class="Results-row_cell">'+e+"</td>"}).join("")+"</tr>"}).join("")+"\n    </tbody>\n    ":""}function normalizeString(e){return(0,_lodash.deburr)(e.toLocaleLowerCase())}function init(){processVoterData().then(function(e){document.querySelector(".Wrapper--loading").classList.remove("Wrapper--loading"),document.querySelector('[data-js="input"]').addEventListener("keyup",function(r){document.querySelector('[data-js="results"]').innerHTML=renderResults(search({query:r.target.value,voters:e}))})})}var _csvtojson=require("csvtojson"),csv=_interopRequireWildcard(_csvtojson),_voters=require("./voters.js"),_lodash=require("lodash");init();
